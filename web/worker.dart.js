...
(function dartProgram() {
  ...
  Y = {
    main() {
      var t1,
        $self = type$.SharedWorkerGlobalScope._as(self);
  ...
  G._IndexedDbStorage.prototype = {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return P._asyncAwait(C.ObjectStore_methods.put$2(transaction.objectStore("moor_databases"), W.Blob_Blob([data]), $async$self.name), $async$store$1);
            case 2:
              // returning from await.
              $async$goto = 3;
    ...
    restore$0() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, reader, t1, result, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return P._asyncAwait(C.ObjectStore_methods.getObject$1(C.Database_methods.transactionStore$2($async$self.get$_database(), "moor_databases", "readonly").objectStore("moor_databases"), $async$self.name), $async$restore$0);
            case 3:
              // returning from await.
  ...
  Y.main_closure.prototype = {
    call$1($event) {
      this.server.serve$1(G.PortToChannel_channel(J.get$first$ax(type$.MessageEvent._as($event).ports)));
    },
    $signature: 4
  };
  (function aliases() {
