...
class ResponsiveHelper {
  ...
  factory ResponsiveHelper(BuildContext context) => ResponsiveHelper._internal(context);
  ...
  bool get isMediumScreen =>
      MediaQuery.of(context).size.width >= 760 && MediaQuery.of(context).size.width <= 1200;
}
