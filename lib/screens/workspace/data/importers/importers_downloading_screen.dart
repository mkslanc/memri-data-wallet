                ...
                children: [
                  Row(
                    children: [
                      Text("Success!",
                          style: TextStyle(
                              fontSize: 12, color: app.colors.brandBlack)),
                    ],
                  ),
                  SizedBox(height: 8),
                  Row(
                    children: [
                      Text("On your phone",
                          style: TextStyle(
                              fontSize: 30, color: app.colors.brandBlack)),
                    ],
                  ),
                  SizedBox(height: 8),
                  Row(
                    children: [
                      Text(
                          "Whatsapp has sucessfully connected to your POD. Your data is being imported, this may take a while. You can navigate away from this screen while your data is importing.",
                          style: TextStyle(
                              fontSize: 14, color: app.colors.brandGreyText)),
                    ],
                  ),
                  SizedBox(height: 64),
                  Row(
                    ...
                    children: [
                      Text("Uploading WhatsApp data:",
                          style: TextStyle(
                              fontSize: 14, color: app.colors.brandBlack)),
                      SizedBox(width: 4),
                      Text(
                          (progress == null
                              ? "starting"
                          ...
                          style: TextStyle(
                              fontSize: 30, color: app.colors.brandViolet)),
                    ],
                  ),
                  SizedBox(height: 64),
                  Row(
