...
class CVUConstantInt extends CVUConstant {
  ...
  factory CVUConstantInt.fromJson(Map<String, dynamic> json) =>
      _$CVUConstantIntFromJson(json);
}
...
class CVUConstantBool extends CVUConstant {
  ...
  factory CVUConstantBool.fromJson(Map<String, dynamic> json) =>
      _$CVUConstantBoolFromJson(json);
}
